...
<footer class="footer">
    <ul>
        ...
        <div class="allsocials">
            ...
            <li><a class="social" href="#" onclick='window.open("https://www.instagram.com/rochorizoncollege/?hl=nl");return false;'><img class="logo" src="pictures/instagram.png" alt="instagram"></a></li>
        </div>
    </ul>
</footer>
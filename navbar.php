...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark p-3 bg-green" id="headerNav">
        <div class="container-fluid">
            ...
            <div class="hamburger collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item d-none d-lg-block">
                        <a class="nav-link mx-2" href="index.php">
                            <img src="pictures/codegardenlogo_transparent.png" height="80" />
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mx-2 active" href="publics.php">Publics</a>
                    </li>
                    <li class="nav-item">
